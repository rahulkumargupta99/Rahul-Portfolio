    ...
    >
      ...
      <div className="flex justify-center">
        <form
          ...
          className="bg-gradient-to-r from-teal-400 to-blue-500 shadow-lg w-full max-w-lg px-8 py-6 rounded-lg border border-gray-200"
        >
          ...
          <div className="flex flex-col mb-4">
            ...
            <input
              ...
              className="shadow-sm border rounded-lg py-2 px-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-yellow-400"
              id="name"
              name="name"
              type="text"
          ...
          <button
            type="submit"
            className="bg-yellow-400 text-gray-800 rounded-lg px-4 py-2 hover:bg-yellow-500 transition duration-300 w-full"
          >
            Send
          </button>
        </form>
